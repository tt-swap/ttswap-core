...
用户购买,协议中商品数量Q(A)减少.Q(A1)=2000-1000=1000
协议中商品的单位价值P(A)发生变化成 P(A1)=3
* 例2：用户出售价值1000购买,购买了商品A.

用户出售,说明商品的市场价值减少.V(A2)=2000-1000=1000
用户出售,协议中商品数量Q(A)增加.Q(A2)=2000+1000=3000
协议中商品的单位价值P(A)发生变化 P(A2)=0.3333
...
3.协议交易前所有商品的市场价值=协议交易后所有商品的市场价值。 
