...
contract normallimitorder is Test, GasSnapshot, BaseSetup {
    ...
    function testaddlimitorder1() public {
        ...
        orderid[0] = 1;
        console2.log(8, 1);
        S_orderDetails[] memory _order_output = tts_limitorder.queryLimitOrder(
            orderid
        );
        console2.log(9, 1);
        assertEq(
    ...
    function testaddlimitorder2() public {
        ...
        vm.startPrank(users[1]);
        console2.log(2, 1);
        S_orderDetails[] memory _order = new S_orderDetails[](2);
        console2.log(3, 1);
        //  S_orderDetails[] memory _order_output;
        ...
        orderid[1] = 2;
        console2.log(8, 1);
        S_orderDetails[] memory _order_output = new S_orderDetails[](2);
    ...
    function testaddlimitorder3() public {
        ...
        vm.startPrank(users[1]);
        console2.log(2, 1);
        S_orderDetails[] memory _order = new S_orderDetails[](3);
        console2.log(3, 1);
        //  S_orderDetails[] memory _order_output;
        console2.log(4, 1);
        _order[0].timestamp = uint96(0);
        ...
        S_orderDetails memory _orderkk;
