...
contract investNativeETHValueGood is BaseSetup {
    ...
    function testinvestOwnNativeETHValueGood() public {
        ...
        market.investGood{value: 50000000000}(1, 0, 50000 * 10 ** 6, users[2]);
        ...
        market.investGood{value: 50000000000}(1, 0, 50000 * 10 ** 6, users[2]);
        snapLastCall("invest_own_nativeeth_valuegood_second_without_refer");

        market.addreferer(users[3]);
        market.investGood{value: 50000000000}(1, 0, 50000 * 10 ** 6, users[2]);
        snapLastCall("invest_own_nativeeth_valuegood_second_with_refer_first");
        assertEq(
            market.getGoodsFee(1, good_.owner),
            4500000,
            "after invest metagood:good_.owner fee error"
        ...
        market.investGood{value: 50000000000}(1, 0, 50000 * 10 ** 6, users[2]);
        snapLastCall("invest_own_nativeeth_valuegood_second_with_refer_second");
        vm.stopPrank();
    }
    ...
    function testinvestotherNativeETHValueGood() public {
        ...
        market.investGood{value: 50000000000}(1, 0, 50000 * 10 ** 6, users[3]);
        ...
        market.investGood{value: 50000000000}(1, 0, 50000 * 10 ** 6, users[3]);
        snapLastCall("invest_other_nativeeth_valuegood_second_without_refer");

        market.addreferer(users[4]);
        market.investGood{value: 50000000000}(1, 0, 50000 * 10 ** 6, users[3]);
        snapLastCall(
            "invest_other_nativeeth_valuegood_second_with_refer_first"
        );
        assertEq(
            market.getGoodsFee(1, good_.owner),
            3250000,
        ...
        market.investGood{value: 50000000000}(1, 0, 50000 * 10 ** 6, users[3]);
        snapLastCall(
            "invest_other_nativeeth_valuegood_second_with_refer_second"
        );
        vm.stopPrank();
    }
}
